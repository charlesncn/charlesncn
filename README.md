...
> *Language* Java.   [Link to the Repo](https://github.com/charlesncn/CPMS)

**Markdown BLOG**
> *Technologies* MongoDb, Ejs, React, NodeJs.  [Link to the Repo](https://github.com/charlesncn/Mern_Blog)

**Food Orderng App**
> *Technologies* MongoDb, Ejs, React, NodeJs.\  [Link to the Repo](https://github.com/charlesncn/food_ordering_mern)
